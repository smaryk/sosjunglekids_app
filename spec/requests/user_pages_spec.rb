...
describe "User pages" do
  ...
  describe "index" do
    before do
      ...
      FactoryGirl.create(:user, first_name: "Bob", last_name: "Test", email: "bob@example.com")
      FactoryGirl.create(:user, first_name: "Ben", last_name: "Test", email: "ben@example.com")
      visit users_path
    end
  ...
  describe "profile page" do
    ...
    let!(:m1) { FactoryGirl.create(:newspost, user: user, content: "Foo") }
    let!(:m2) { FactoryGirl.create(:newspost, user: user, content: "Bar") }
    ...
    describe "newsposts" do
      ...
      it { should have_content(user.newsposts.count) }
    end
  end
